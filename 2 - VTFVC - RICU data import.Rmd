...
## Patient populations
```{r loaddata}
#This block is slow. Only rerun if imported tables need to be updated.
# 
library(tidyverse)
library(ricu)
library(data.table)
...
vent.settings <- concept(
  c("tv1", "tv2", "tv3", "tv4", "ventmode1", "ventmode2", "peep1", "peep2", "plateau"),
  list(
  ...
  description = c("tvset1", "tvset2", "tvset3", "tvset4", "ventmode1", "ventmode2", "peep1", "peep2", "plateau"))
...
```{r}
miiv.subjects<- readRDS("miiv.subjects.Rds")
miiv.vent<- readRDS("miiv.vent.Rds")
miiv.sfratios<- readRDS("miiv.sfratios.Rds")
miiv.demo<- readRDS( "miiv.demo.Rds")
miiv.sofa<- readRDS( "miiv.sofa.Rds")
...
```{r}
eicu.vent <- readRDS("eicu.vent.Rds")
eicu.sofa <- readRDS("eicu.sofa.Rds")
eicu.sfratios <- readRDS("eicu.safi.Rds")
eicu.demo <- readRDS("eicu.demo.Rds")
